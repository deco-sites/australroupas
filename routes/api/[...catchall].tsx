...
const proxyTo = `https://austral.vtexcommercestable.com.br/api`;
...
const getSecure: Handlers["GET"] = (req, ctx) => {
  const url = req.url;

  if (url.indexOf("_secure")) {
    return Response.redirect("https://www.austral.com.br/_secure/account", 307);
  } else {
    return new Response("ok");
  }
};

export const handlerSecure: Handlers = {
  GET: getSecure,
};
