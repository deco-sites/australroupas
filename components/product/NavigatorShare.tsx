...
function NavigatorShare({ title, url }: Props) {
  ...
  return (
    <>
      ...
      <div class={`${displayModalShare.value ? "flex z-[51]" : "hidden"} w-full h-screen pointer-events-none fixed top-0 right-0 justify-center items-center `}>
        <div class="relative w-[32em] bg-white text-[1rem] p-[1.25em] max-w-[277px] min-h-[153px] rounded pointer-events-auto flex flex-col gap-[25px] justify-center items-center">
          ...
          <div class="flex justify-between items-center w-[110px]">
            <a href={`javascript: window.open('https://wa.me/?text=${url}', '_blank', 'noopener noreferrer');`}>
              <i class="product__social-icon icon icon-whatsapp text-primary text-[22px]" />
            </a>
            <a href={`javascript: window.open('https://www.facebook.com/sharer/sharer.php?u=${url}', '_blank', 'noopener noreferrer');`}>
              <i class="product__social-link product__social-link--facebook icon icon-facebook text-primary text-[22px]" />
            </a>
            <a href={`javascript: window.open('https://www.pinterest.com/sharer/sharer.php?u=${url}', '_blank', 'noopener noreferrer');`}>
