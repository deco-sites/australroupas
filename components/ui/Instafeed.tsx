...
export default function Instafeed({ images, title }: Props) {
  ...
  return (
    <div class="sm:home-container">
      ...
      >
        <Slider class="carousel carousel-center w-full col-span-full row-span-full scrollbar-none gap-6 sm:gap-0">
          {images.map((image, index) => {
            return (
              ...
              >
                <a class="cursor-pointer" href={image.href} target="_blank">
                  <Image
